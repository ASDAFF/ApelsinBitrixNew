...
<footer>
    <div class="center<?= ($arSetting['SITE_BACKGROUND']['VALUE'] == 'Y' ? ' inner' : ''); ?>">
        <div class="footer_menu_soc_pay">
            <div class="footer_errorMsg">Заметили неточность или ошибку? <span class="orange">Сообщите</span> нам,
                пожалуйста.
            </div>
            <script>
                ...
                <div class="footer_contacts">
                    <div class="schedule">
                        <div class="main_phone">
                            <div class="phone"><span>8 (800) </span>550-54-43</div>
                        </div>
                        <div class="time">
    ...
    <div class="lawProductContentForSiteCatalog">Информация о товаре, представленном на сайте, не является публичной
        офертой. Характеристики, комплект поставки, внешний вид, страна и место производства товара могут
        отличаться от указанных или могут быть изменены производителем без отображения в каталоге магазина
        АПЕЛЬСИН. Условия приобретения товара требуют согласования с менеджером магазина.
    </div>
