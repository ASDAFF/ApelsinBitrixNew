...
$total = \Bitrix\Sale\BasketComponentHelper::getFUserBasketPrice($fuserId, SITE_ID);
...
$arResult["SUM"] = $total;
$arResult["SUM_FORMATED"] = number_format($total, $arResult["DECIMALS"], $arResult["DEC_POINT"], $arResult["THOUSANDS_SEP"]);
