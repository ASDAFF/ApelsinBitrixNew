...
$MESS["SOA_YES"] = "да";
$MESS["SOA_NO"] = "нет";
$MESS["SOA_DO_SOC_SERV"] = "Войти как пользователь:";
...
$MESS["SOA_ORDER_SUC1"] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Персональном разделе сайта</a>.<br> Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.";
$MESS["SOA_PAY"] = "Оплата заказа";
$MESS["SOA_PAY_LINK"] = "Настоятельно рекомендуем до оплаты дождаться обработки заказа менеджером (статус: Обработан) <br><a class='confirm_link' href=\"#LINK#\" target=\"_blank\">Оплатить заказ</a>.";
...
$MESS["STOF_LOGIN"] = "Логин или Электронная почта";
...
$MESS["DELIVERY_BLOCK_NAME_DEFAULT"] = "Способы доставки";
$MESS["BUYER_BLOCK_NAME_DEFAULT"] = "Дополнительная информация";
...
$MESS["NAV_BACK_DEFAULT"] = "&larr;&nbsp;Ctrl";
$MESS["NAV_FORWARD_DEFAULT"] = "Ctrl&nbsp;&rarr;";
...
$MESS["USE_COUPON_DEFAULT"] = "Введите купон";
