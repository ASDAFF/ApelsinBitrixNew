			...
			<div class="equipment-order list">
				...
				<div class="tbody">
					<?foreach($arResult["ORDERS"] as $key => $val) {
						...
						<div class="tr">
							<div class="tr_into">
                                <!-- APLS - Клик по облости для раскрытия -->
                                ...
                                <!-- APLS - Клик по облости для раскрытия - END -->
...
<!--                                            --><?//endif;
											...
											if(isset($val["ORDER"]["PSA_ACTION_FILE"]) && !empty($val["ORDER"]["PSA_ACTION_FILE"]) && $val["ORDER"]["STATUS_ID"]!="F" && ($val["ORDER"]["STATUS_ID"]=="A" || APLS_OrderCheck::orderItemsPayPermission($val["BASKET_ITEMS"]))) {?>
												<br />
