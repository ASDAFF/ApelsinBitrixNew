...
<div id="items-sections" class="items-sections catalog-promotions-price-view">
	...
	foreach($arResult["SECTIONS"] as $arSection) {?>
		<div class="items-section">
			...
			<div class="items-section__childs">
				<div class="catalog-item-cards catalog-item-price-view">
