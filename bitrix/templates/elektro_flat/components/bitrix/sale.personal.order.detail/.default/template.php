					...
					<div class="sale-order-detail-about-order-inner-container">
						...
						<? if ($arParams['GUEST_MODE'] !== 'Y') { ?>
							<div class="sale-order-detail-about-order-inner-container-repeat order-item-actions">
								<div>
									<a class="btn_buy apuo order_repeat" href="<?=$arResult["URL_TO_COPY"]?>" title="Повторить заказ">
								...
								<? if ($arResult["CAN_CANCEL"] === "Y") { ?>
									<div>
										<a class="btn_buy apuo order_delete" href="<?=$arResult["URL_TO_CANCEL"]?>" title="Отменить заказ">
