...
<?//COLLECTION//
$arValue = false;
$arItems = CIBlockElement::GetList(array("SORT" => "ID"),array("PROPERTY_COLLECTION" => $ElementID),false,false,array("ID"));
...
<?//RELATED_ITEMS//
if(!isset($arResult["VARIABLES"]["SECTION_ID"]) || empty($arResult["VARIABLES"]["SECTION_ID"]) && !$arValue)
