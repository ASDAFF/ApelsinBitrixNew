...
$arCompare = array();
if(isset($_SESSION[$arParams["COMPARE_NAME"]][$arParams["IBLOCK_ID"]]["ITEMS"]))
	$arCompare = $_SESSION[$arParams["COMPARE_NAME"]][$arParams["IBLOCK_ID"]]["ITEMS"];
...
if(!empty($arCompare) && is_array($arCompare)) {?>
	...
	ShowNote(GetMessage("CATALOG_COMPARE_LIST_EMPTY"), "infotext");?>