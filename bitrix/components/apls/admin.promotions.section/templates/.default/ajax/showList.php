...
foreach ($sections as $section) {
    if($section instanceof PromotionSectionModel) {
        $editButton = "<a class='editButton' href='javascript:void(0)' sectionId='".$section->getId()."' sectionName='".$section->getFieldValue('section')."'>изменить</a>";
        ...
        $content .= "<div class='buttonPanel'>$editButton $delButton</div>";
