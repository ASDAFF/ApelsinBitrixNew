...
var IPOLapiship_pvz = {
	...
	button: '<a href="javascript:void(0);" id="apiship_selectPVZ" onclick="IPOLapiship_pvz.selectPVZ(); return false;"><?=GetMessage("IPOLapiship_FRNT_CHOOSEPICKUP")?></a>',// html ������ "������� ���".
	...
	initCityPVZ: function(){ // ������ ������ ���������� ��� ���������� ������
		...
		IPOLapiship_pvz.PVZHTML();//������ html PVZ. ��� ���� ��������� �� �������, �� �� ��������.
	...
	jquiready: function()
	{
		...
		// ymaps.ready(IPOLapiship_pvz.CheckChosenPickUp);// ��� ����������� ������ �� ���������
		
		$(orderForm).submit(function(e){
			// ������ �� ������ �������� �����
			if (BX('confirmorder').value == "Y")
			{
				IPOLapiship_pvz.CheckChosenPickUp();// ��������� ������ �� ���������
