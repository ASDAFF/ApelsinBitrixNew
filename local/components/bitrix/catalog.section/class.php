...
class CatalogSectionComponent extends ElementList
{
	...
	{
	    /*
	     * отключаем базовый фильтр, который включает в себя
	     * - фильтр по дате активности
	     * - фильтр по сайту
	     * - проверку прав пользователя
	     *
	     * это очень ресурсоемкие проверки и они не требуются, тк
	     * - товары либо активны, либо нет - без привязки к дате
	     * - сайт всего один и все товары по умолчанию привязаны к нему
